...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    private boolean isHomeFragment; // Flag to determine which fragment

    // Constructor
    public CourseAdapter(Context context, List<Course> courseList, boolean isHomeFragment) {
    ...
    public void onBindViewHolder(@NonNull CourseViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = createIntentForCourse(course);
    ...
    // Create intent based on the course and fragment type
    private Intent createIntentForCourse(Course course) {
        Intent intent;
        if (isHomeFragment) {
